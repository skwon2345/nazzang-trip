    ...
    slots: [
      {
        ...
        icon: "🛫",
        tip: "기내에서 꼭 자두세요! 도착하자마자 사막 투어 출발!",
      },
      {
        time: "05:20",
        title: "캄란(나트랑) 공항 도착",
      ...
      },
      {
        time: "06:00",
        title: "판랑 사막 투어 출발",
        desc: "공항에서 바로 판랑으로! 약 1시간 30분 소요",
        icon: "🚗",
        tip: "투어 차량 사전 예약 필수! 짐은 차에 보관",
        lat: 11.9981,
        lng: 109.2193,
      },
      {
        ...
        desc: "붉은 모래사막 도착! 아침 햇살 아래 사막 탐험",
        icon: "🏜️",
        lat: 11.5733,
        lng: 108.9872,
      },
      ...
      },
      {
        time: "09:30",
        title: "판랑 로컬 아침식사",
        desc: "판랑 시내에서 반깐(Banh Can) - 판랑에서만 먹을 수 있는 명물!",
        icon: "🥘",
        tip: "반깐은 계란+쌀가루 구이. 판랑 와야만 먹을 수 있어요!",
        lat: 11.5821,
        lng: 108.9910,
      },
      {
      ...
      },
      {
        time: "14:00",
        title: "복귀 출발",
        desc: "판랑에서 나트랑 리조트로 복귀 (약 1시간 30분)",
        icon: "🚗",
      },
      {
        time: "16:00",
        title: "아나만다라 캄란 체크인",
        desc: "리조트 도착! 체크인 후 샤워 & 휴식",
        icon: "🏨",
        tip: "투어 후 피곤하니까 충분히 쉬세요!",
        lat: 12.0820,
        lng: 109.1943,
      },
      {
        time: "18:00",
        title: "리조트 선셋 & 풀장",
        desc: "프라이빗 비치에서 일몰 감상 후 풀장에서 여유롭게",
        icon: "🌅",
      },
      {
        time: "19:30",
        title: "리조트 디너",
        desc: "Ana Beach House에서 씨푸드 BBQ & 베트남 요리",
        icon: "🍽️",
        tip: "비치프론트 오픈키친에서 선셋 디너!",
        lat: 12.0820,
        lng: 109.1943,
      },
    ],
    ...
    slots: [
      {
        time: "09:00",
        title: "늦잠 & 리조트 조식",
        desc: "어제 판랑 투어 피로 회복! 여유롭게 일어나서 조식 즐기기",
        icon: "☀️",
        lat: 12.0820,
        lng: 109.1943,
      },
      ...
      },
      {
        time: "16:00",
        title: "카약 or SUP 체험",
        desc: "리조트 해변에서 커플 카약 또는 스탠드업 패들보드",
        icon: "🛶",
        tip: "리조트 프론트에서 무료 대여 가능한지 확인!",
      },
      {
        time: "17:30",
        title: "선셋 칵테일",
      ...
      },
      {
        time: "19:00",
        title: "리조트 디너",
        desc: "Ana Beach House에서 씨푸드 코스요리. 비치프론트 파인다이닝",
        icon: "🦞",
        tip: "미리 테라스석/비치석 요청!",
        lat: 12.0820,
        lng: 109.1943,
  ...
  },
  {
    ...
    slots: [
      ...
      },
      {
        ...
        desc: "나트랑 해변 아이코닉 바 & 레스토랑. 라이브 음악과 칵테일",
        icon: "⛵",
        tip: "해변 테이블에서 분위기 즐기기!",
        lat: 12.2448,
        lng: 109.1955,
      },
      {
        ...
        desc: "하바나 호텔 43~45층 루프탑 바. 360도 나트랑 야경 & 스카이워크",
        icon: "🌃",
        tip: "유리 스카이워크에서 인생샷! 입장료 별도",
        lat: 12.2415,
        lng: 109.1960,
      },
    ],
